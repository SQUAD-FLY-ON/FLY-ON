...
export default function NearActivity() {
    ...
    return (
        ...
        <View style={styles.container}>
            <View style={styles.titleContainer}>
                <Pressable onPress={handlePresentModalPress}>
                    <View style={styles.titleRow}>
                        <Text style={styles.title}>{filterOptions.find((value) => value.key === currentKey)?.label}</Text>
            ...
            />
            <FilterModal ref={filterModalRef} options = {filterOptions} currentKey={currentKey} setCurrentKey={setCurrentKey}  />
        </View>
    );
}
